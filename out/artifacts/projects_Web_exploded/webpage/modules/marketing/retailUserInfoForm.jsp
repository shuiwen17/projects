	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/marketing/retailUserInfo/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="retailUserInfo" class="form-horizontal">
		<form:hidden path="id"/>
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:userselect id="user" name="user.id" value="${retailUserInfo.user.id}" labelName="user.name" labelValue="${retailUserInfo.user.name}"
				...
				<tr>
					...
					<td class="width-35">
						<div class='input-group form_datetime' id='createTime'>
							<input type='text'  name="createTime" class="form-control "  value="<fmt:formatDate value="${retailUserInfo.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
