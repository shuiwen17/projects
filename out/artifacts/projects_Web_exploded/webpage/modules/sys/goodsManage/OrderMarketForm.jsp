...
<script type="text/javascript">
	function save() {
		...
		if (!isValidate) {
			...
			jp.loading();
			jp.post("${ctx}/sys/orderMarket/save", $('#inputForm').serialize(),
					function(data) {
						if (data.success) {
...
<body class="bg-white">
	<form:form id="inputForm" modelAttribute="orderDetail" action="${ctx}/sys/orderMarket/form"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		   ...
		   <tbody>
		      ...
		      <td class="width-15 active"><label class="pull-right"><font color="red">*</font>选择商品：</label></td>
		       ...
		       <tr>
		          ...
		          <td  class="width-35" ><form:input path="goodsPrice" htmlEscape="false" maxlength="50" class="form-control required number"/></td>
		      </tr>
		      <tr>
