...
<%@include file="OrderMarketList.js"%>
<%-- <c:if test=" main = null}">
	...
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">商品销售额排名</h3>
			</div>
			
		<if test="main != null and carrier !='' and main !='0'.toString()">
		...
		<!-- <if test="main == null and carrier =='' and main =='0'.toString()">
			...
			<div id="search-collapse" class="collapse">
				<div class="accordion-inner">
					<form:form id="searchForm" modelAttribute="orderMarket" class="form form-horizontal well clearfix">
			...
			<!-- 工具栏 -->
			<div id="toolbar">
				<shiro:hasPermission name="sys:goodsManage:orderMarket:add">
					<button id="add" class="btn btn-primary" onclick="add()">
						<i class="glyphicon glyphicon-plus"></i> 新建
					</button>
				</shiro:hasPermission>
				<shiro:hasPermission name="sys:goodsManage:orderMarket:edit">
					<button id="edit" class="btn btn-success" disabled onclick="edit()">
						<i class="glyphicon glyphicon-edit"></i> 修改
					</button>
				</shiro:hasPermission>
				<shiro:hasPermission name="sys:goodsManage:orderMarket:del">
					<button id="remove" class="btn btn-danger" disabled
						onclick="deleteAll()">
						<i class="glyphicon glyphicon-remove"></i> 删除
					</button>
				</shiro:hasPermission>
				<shiro:hasPermission name="sys:goodsManage:orderMarket:view">
			...
			<!-- 表格 -->
			<table id="orderMarketTable" data-toolbar="#toolbar"></table>
